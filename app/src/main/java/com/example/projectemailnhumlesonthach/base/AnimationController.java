...
public class AnimationController {
    ...
    public void setFragmentFromTop(Fragment context, int id, Fragment fragmentTo) {
        FragmentTransaction fragmentTransaction = context.getChildFragmentManager().beginTransaction();
        fragmentTransaction.setCustomAnimations(R.anim.slide_in_top, R.anim.slide_out_bottom);
        fragmentTransaction.replace(id, fragmentTo);
        fragmentTransaction.commit();
    }

    public void setFragmentFromTop(BaseActivity context, int id, Fragment fragment) {
