...
public class SendMailAdapter extends RecyclerView.Adapter<SendMailAdapter.MyViewHolder> {
    ...
    public SendMailAdapter(Context context, ArrayList<User> users,boolean isMail) {
    ...
    @NonNull
    @Override
    public SendMailAdapter.MyViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_send, parent, false);
        return new SendMailAdapter.MyViewHolder(view);
    }

    @Override
    public void onBindViewHolder(@NonNull SendMailAdapter.MyViewHolder holder, int position) {
    ...
    private void lastMesssge(String userid,TextView last_title,TextView last_content,TextView last_time){
